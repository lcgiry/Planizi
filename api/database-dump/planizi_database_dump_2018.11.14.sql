...
CREATE TABLE `availibility_equipment` (
  `availibility_equipment_id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`availibility_equipment_id`),
...
CREATE TABLE `availibility_user` (
  `availibility_user_id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  `createdAt` datetime DEFAULT NULL,
  `updatedAt` datetime DEFAULT NULL,
  PRIMARY KEY (`availibility_user_id`),
...
INSERT INTO `rights` VALUES ('admin',NULL,'Admin','third level, for organizer and people who need advanced access',NULL,NULL),('limited',NULL,'Limité','first level, default for all new user',NULL,NULL),('standard',NULL,'Standard','second level, for all user after having validated by administrators',NULL,NULL),('super_admin',NULL,'Super Admin','last level, for administrator of the platform',NULL,NULL);
...
INSERT INTO `role` VALUES ('organizer','Organizer','Organisateur','a person who organize the event',NULL,NULL),('service_provider','Service provider','Pretastaire','a person who come to bring a service',NULL,NULL),('technician','Technician','Technicien','a person with the technician status',NULL,NULL),('visitor','Visitor','Visiteur','a person who has no status',NULL,NULL),('volunteer','Volunteer','Bénévole','a person who is not paid and want help during the event',NULL,NULL);
...
INSERT INTO `skill` VALUES ('caces_1','Caces 1','Caces 1','',NULL,NULL),('caces_10','Caces 10','Caces 10',NULL,NULL,NULL),('caces_2','Caces 2','Caces 2',NULL,NULL,NULL),('caces_3','Caces 3','Caces 3',NULL,NULL,NULL),('caces_4','Caces 4','Caces 4',NULL,NULL,NULL),('caces_5','Caces 5','Caces 5',NULL,NULL,NULL),('caces_6','Caces 6','Caces 6',NULL,NULL,NULL),('caces_7','Caces 7','Caces 7',NULL,NULL,NULL),('caces_8','Caces 8','Caces 8',NULL,NULL,NULL),('caces_9','Caces 9','Caces 9',NULL,NULL,NULL),('driver_licence','Driver licence','Permis B','a person who can drive a classic car',NULL,NULL),('driver_licence_valid','Driver licence 3 years+','Permis B +3 ans','a person who can drive a classic car and who have obtained the licence for 3 years or more',NULL,NULL),('english_bilingual','English bilingual','Anglais Bilingue',NULL,NULL,NULL),('psc1','PSC1/Secourism','PSC1',NULL,NULL,NULL);
...
CREATE TABLE `task_assignment_equipment` (
  `task_assignment_equipment_id` int(11) NOT NULL,
  `task_assignment_equipment_task_shift_subset` int(11) NOT NULL,
  `task_assignment_equipment_equipment` int(11) NOT NULL,
  `task_assignment_equipment_need_fulfilled` int(11) NOT NULL,
  `createdAt` datetime DEFAULT NULL,
  `updatedAt` datetime DEFAULT NULL,
  PRIMARY KEY (`task_assignment_equipment_id`),
...
CREATE TABLE `task_assignment_user` (
  `task_assignment_user_id` int(11) NOT NULL,
  `task_assignment_task_shift_subset` int(11) NOT NULL,
  `task_assignment_user_user` varchar(256) COLLATE utf8_unicode_ci NOT NULL,
  `task_assignment_user_need_fulfilled` int(11) NOT NULL,
  `createdAt` datetime DEFAULT NULL,
  `updatedAt` datetime DEFAULT NULL,
  PRIMARY KEY (`task_assignment_user_id`),
...
INSERT INTO `team` VALUES ('animations_culture',NULL,'Animations culturelles',NULL,NULL,NULL),('animations_entertainment',NULL,'Animations de Divertissement',NULL,NULL,NULL),('animations_sport',NULL,'Animations sportives',NULL,NULL,NULL),('artist_programming',NULL,'Programmation Concerts',NULL,NULL,NULL),('communication',NULL,'Communication',NULL,NULL,NULL),('logistics_bar',NULL,'Logistique Bar',NULL,NULL,NULL),('logistics_barriers',NULL,'Logistique Barrières',NULL,NULL,NULL),('logistics_electricity',NULL,'Logistique Electricité, Eau, Bâtiments',NULL,NULL,NULL),('logistics_home_artist',NULL,'Logistique Accueil Artiste',NULL,NULL,NULL),('logistics_material',NULL,'Logistique Matériel',NULL,NULL,NULL),('logistics_scene',NULL,'Logistique des Scènes',NULL,NULL,NULL),('logistics_security',NULL,'Logistique Sécurité',NULL,NULL,NULL),('logistics_signage',NULL,'Logistique Signalétique & Décoration',NULL,NULL,NULL),('logistics_staff',NULL,'Logistique Bénévole',NULL,NULL,NULL),('logistics_ticketing',NULL,'Logistique Billetterie',NULL,NULL,NULL),('prevention_sustainable_development',NULL,'Prévention et Développement Durable',NULL,NULL,NULL),('races',NULL,'Courses',NULL,NULL,NULL),('sponsoring',NULL,'Sponsoring et Partenariats',NULL,NULL,NULL),('technics',NULL,'Teckos',NULL,NULL,NULL),('volonteer',NULL,'Bénévole',NULL,NULL,NULL);
...
CREATE TABLE `user` (
  ...
  `user_driver_licence_file` varchar(256) COLLATE utf8_unicode_ci DEFAULT NULL,
  `user_cv_file` varchar(256) COLLATE utf8_unicode_ci DEFAULT NULL,
...
INSERT INTO `user` VALUES ('HELOO','Szefff','Zerety','test','m','0667960741','1996-06-07','testt','lot',NULL,'M',NULL,NULL,NULL,'admin','organizer',NULL,NULL,NULL,NULL,NULL,NULL,'2018-11-13 11:32:34','2018-11-13 11:32:34'),('johdd','John','John','test','m','0667960741','1970-01-01','testt','lot',NULL,'S',NULL,NULL,NULL,'admin','organizer',NULL,NULL,NULL,NULL,NULL,NULL,'2018-11-12 12:39:10','2018-11-12 12:39:10'),('john','john','Ratignier','test','m','0667960741','1996-06-07','testt','lot',NULL,'S',NULL,NULL,NULL,'admin','organizer',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),('john71570@gmail.com','John','John','test','m','0667960741','1970-01-01','testt','lot',NULL,'S',NULL,NULL,NULL,'admin','organizer',NULL,NULL,NULL,NULL,NULL,NULL,'2018-11-12 12:31:55','2018-11-12 12:31:55'),('johndd','John','Ratignier','test','m','0667960741','1996-06-07','testt','lot',NULL,'S',NULL,NULL,NULL,'admin','organizer',NULL,NULL,NULL,NULL,NULL,NULL,'2018-11-12 11:07:29','2018-11-12 11:07:29'),('johnddt','John','John','test','m','0667960741','1996-06-07','testt','lot',NULL,'S',NULL,NULL,NULL,'admin','organizer',NULL,NULL,NULL,NULL,NULL,NULL,'2018-11-12 12:31:28','2018-11-12 12:31:28');
...
CREATE TABLE `user_skill` (
  ...
  KEY `FK_user_skill_user_idx` (`user_skill_user`),
...
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='Table for joining User and Skill';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `user_skill` VALUES (1,'john71570@gmail.com','caces_1',NULL,NULL),(2,'john71570@gmail.com','caces_3',NULL,NULL);
...
CREATE TABLE `user_team` (
  ...
  KEY `FK_user_team_user_idx` (`user_team_user`),
...
-- Dump completed on 2018-11-14 19:19:05
